...
public class UserFixture {
    ...
    public static LoginRequest 로그인_시도_회원() {
        return new LoginRequest(email, password, fcmToken);
    }

    public static LoginRequest 로그인_실패_회원() {
        return new LoginRequest(email, failedLoginPassword, fcmToken);
    }

    public static LoginRequest 로그인_성공_회원() {
        return new LoginRequest(successLoginEmail, password, fcmToken);
    }
